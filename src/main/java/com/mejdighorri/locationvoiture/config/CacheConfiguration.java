package com.mejdighorri.locationvoiture.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("locationVoiture");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("locationVoiture");
        ...
        config.getMapConfigs().put("com.mejdighorri.locationvoiture.domain.*", initializeDomainMapConfig(jHipsterProperties));
